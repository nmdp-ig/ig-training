CodeSystem: GVHD_CADSR_VM_CS
Title: "NIH Common Data Element Value Meanings for GVHD"
Id: cibmtr-cadsr-vm-cs
Description: "NIH Common Data Element Value Meanings for GVHD"
* ^url = $CADSR
* ^version = "2023"
* ^status = #active
* ^experimental = false
