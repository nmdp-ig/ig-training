...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Condition">
      <sch:assert test="count(f:extension[@url = 'http://example.org/ig/exampleig/StructureDefinition/number-of-remissions']) &lt;= 1">extension with URL = 'http://example.org/ig/exampleig/StructureDefinition/number-of-remissions': maximum cardinality of 'extension' is 1</sch:assert>
